      ...
      <form onSubmit={onSubmit} className="itemDetails__box">
        <div className="itemDetails__form-wrap">
          <div className="itemDetails__form">
            ...
            <label className="itemDetails__label-h3" htmlFor="name">
              Item Name
            </label>
            <input
          ...
          <div className="itemAvail">
            ...
            <label className="itemAvail__label-h3" htmlFor="">
              {" "}
              Status
            </label>
            {/* instock */}
            <div className="itemAvail__box">
              <li className="itemAvail__list">
                <input
              ...
              {/* out of stock */}
              <li className="itemAvail__list">
                <input className="itemAvail__radio" type="radio" />
                Out of stock
              </li>
            </div>
            ...
            {openQuantity === true ? (
              <div className="itemAvail__quantity">
                <label className="itemDetails__label-h3" htmlFor="">
                  Quantity
                </label>
                <input
                  className="itemDetails__input"
        ...
        <div className="itemDetails__btn-frame">
          <button onClick={handleCancel} className="itemDetails__btn-cancel">
            Cancel
          </button>
